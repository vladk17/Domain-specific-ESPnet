...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ]; then
   ...
   echo "STAGE 0: Data download and preparation"
    ...
    utils/combine_data.sh data/train data/train_crowdsource data/train_mailabs data/train_tedx data/train_comvoice
    utils/combine_data.sh data/test data/test_crowdsource data/test_mailabs data/test_tedx data/test_comvoice

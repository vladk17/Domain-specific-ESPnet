...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
    ...
    spm_train --input=data/lang_char/input.txt --vocab_size=${nbpe} --hard_vocab_limit=false --model_type=${bpemode} --model_prefix=${bpemodel} --input_sentence_size=100000000

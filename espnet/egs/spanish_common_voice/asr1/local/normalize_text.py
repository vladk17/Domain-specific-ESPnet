...
def digit2words(x, L):
    result = " ".join( #'' if math.isnan(a) else \
...
def normalize(inFile, format, lang):
    ...
    for line in infile:
        try:
            ...
            print("Exception occurred during normalization: class name: {}, e: {}".format( e.__class__.__name__, e))
...
def run_normalization(rest, lang):
    ...
    try: 
        ...
        print("Exception occurred during digit2words: class name: {}, e: {}".format( e.__class__.__name__, e))
        rest = rest

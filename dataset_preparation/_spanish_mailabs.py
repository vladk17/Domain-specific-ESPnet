...
if __name__ == '__main__':
    dataset_location = download_and_extract_data(
        ...
        dataset_name='Mailabs', download_folder="/home/stanislav/y-data/gong/Domain-specific-ESPnet/data")
    ...
    #     espnet_kaldi_eg_directory='/home/stanislav/y-data/gong/Domain-specific-ESPnet/espnet_emulation/egs/mailabs/asr1')

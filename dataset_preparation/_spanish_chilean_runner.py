...
if __name__ == '__main__':
    dataset_location = download_and_extract_data(
        dataset_urls=['http://www.openslr.org/resources/71/line_index_female.tsv',
                      'http://www.openslr.org/resources/71/line_index_male.tsv',
                      'http://www.openslr.org/resources/71/es_cl_female.zip',
